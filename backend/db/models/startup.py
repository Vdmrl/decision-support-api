...
class CertificateType(Base):
    ...
    certificate_templates: Mapped[List["CertificateTemplates"]] = relationship(
        "CertificateTemplates", uselist=True, back_populates="certificate_type"
    )
    certificates: Mapped[List["Certificates"]] = relationship(
        "Certificates", uselist=True, back_populates="certificate_type"
    )
...
class ExpertiseCriteriaTypes(Base):
    ...
    expertise_criteria: Mapped[List["ExpertiseCriteria"]] = relationship(
        "ExpertiseCriteria", uselist=True, back_populates="expertise_criteria_types"
    )
    template_expertise_criteria: Mapped[List["TemplateExpertiseCriteria"]] = relationship(
        "TemplateExpertiseCriteria", uselist=True, back_populates="expertise_criteria_types"
    )
...
class FeedbackFieldTypes(Base):
    ...
    feedback_form_fields: Mapped[List["FeedbackFormFields"]] = relationship(
        "FeedbackFormFields", uselist=True, back_populates="feedback_field_types"
    )
...
class FieldTypes(Base):
    ...
    template_fields: Mapped[List["TemplateFields"]] = relationship(
        "TemplateFields", uselist=True, back_populates="field_types"
    )
...
class InstitutionStatuses(Base):
    ...
    institutes: Mapped[List["Institutes"]] = relationship(
        "Institutes", uselist=True, back_populates="institution_statuses"
    )
...
class PassportFieldTypes(Base):
    ...
    passport_fields: Mapped[List["PassportFields"]] = relationship(
        "PassportFields", uselist=True, back_populates="passport_field_types"
    )
    template_passport_fields: Mapped[List["TemplatePassportFields"]] = relationship(
        "TemplatePassportFields", uselist=True, back_populates="passport_field_types"
    )
...
class PassportStatuses(Base):
    ...
    passport_information: Mapped[List["PassportInformation"]] = relationship(
        "PassportInformation", uselist=True, back_populates="passport_statuses"
    )
...
class ProjectRoles(Base):
    ...
    user_project: Mapped[List["UserProject"]] = relationship(
        "UserProject", uselist=True, back_populates="project_roles"
    )
...
class ProjectSearchType(Base):
    ...
    project_search: Mapped[List["ProjectSearch"]] = relationship(
        "ProjectSearch", uselist=True, back_populates="project_search_type"
    )
...
class Regions(Base):
    ...
    institution_regions: Mapped[List["InstitutionRegions"]] = relationship(
        "InstitutionRegions", uselist=True, back_populates="regions"
    )
    support_regions: Mapped[List["SupportRegions"]] = relationship(
        "SupportRegions", uselist=True, back_populates="regions"
    )
...
class SupportDirections(Base):
    ...
    support_support_directions: Mapped[List["SupportSupportDirections"]] = relationship(
        "SupportSupportDirections", uselist=True, back_populates="support_directions"
    )
...
class SupportForms(Base):
    ...
    support_support_forms: Mapped[List["SupportSupportForms"]] = relationship(
        "SupportSupportForms", uselist=True, back_populates="support_forms"
    )
...
class SupportMembers(Base):
    ...
    support_support_members: Mapped[List["SupportSupportMembers"]] = relationship(
        "SupportSupportMembers", uselist=True, back_populates="support_members"
    )
...
class SupportReasons(Base):
    ...
    support_support_reasons: Mapped[List["SupportSupportReasons"]] = relationship(
        "SupportSupportReasons", uselist=True, back_populates="support_reasons"
    )
...
class TrackingFieldTypes(Base):
    ...
    tracking_form_fields: Mapped[List["TrackingFormFields"]] = relationship(
        "TrackingFormFields", uselist=True, back_populates="tracking_field_types"
    )
    tracking_template_fields: Mapped[List["TrackingTemplateFields"]] = relationship(
        "TrackingTemplateFields", uselist=True, back_populates="tracking_field_types"
    )
...
class TrackingStatuses(Base):
    ...
    tracking_information: Mapped[List["TrackingInformation"]] = relationship(
        "TrackingInformation", uselist=True, back_populates="tracking_statuses"
    )
...
class Forms(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["event_statuses_id_event_statuses"], ["event_statuses.id_event_statuses"], name="fk_forms_event_statuses1"
        ),
    ...
    certificate_templates: Mapped[List["CertificateTemplates"]] = relationship(
        "CertificateTemplates", uselist=True, back_populates="forms"
    )
    direction_events: Mapped[List["DirectionEvents"]] = relationship(
        "DirectionEvents", uselist=True, back_populates="forms"
    )
    expertises: Mapped[List["Expertises"]] = relationship("Expertises", uselist=True, back_populates="forms")
    feedback_form_fields: Mapped[List["FeedbackFormFields"]] = relationship(
        "FeedbackFormFields", uselist=True, back_populates="forms"
    )
    form_fields: Mapped[List["FormFields"]] = relationship("FormFields", uselist=True, back_populates="forms")
    industry_directions: Mapped[List["IndustryDirections"]] = relationship(
        "IndustryDirections", uselist=True, back_populates="forms"
    )
    learning_modules: Mapped[List["LearningModules"]] = relationship(
        "LearningModules", uselist=True, back_populates="forms"
    )
    ...
    pervich_criteria: Mapped[List["PervichCriteria"]] = relationship(
        "PervichCriteria", uselist=True, back_populates="forms"
    )
    steps: Mapped[List["Steps"]] = relationship("Steps", uselist=True, back_populates="forms")
    tracking_form_fields: Mapped[List["TrackingFormFields"]] = relationship(
        "TrackingFormFields", uselist=True, back_populates="forms"
    )
    ...
    expertise_criteria: Mapped[List["ExpertiseCriteria"]] = relationship(
        "ExpertiseCriteria", uselist=True, back_populates="forms"
    )
...
class Institutes(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["institution_statuses_id_institution_statuses"],
    ...
    institution_statuses: Mapped["InstitutionStatuses"] = relationship(
        "InstitutionStatuses", back_populates="institutes"
    )
    institution_institution_forms: Mapped[List["InstitutionInstitutionForms"]] = relationship(
        "InstitutionInstitutionForms", uselist=True, back_populates="institutes"
    )
    institution_regions: Mapped[List["InstitutionRegions"]] = relationship(
        "InstitutionRegions", uselist=True, back_populates="institutes"
    )
...
class Users(Base):
    ...
    expertise_templates: Mapped[List["ExpertiseTemplates"]] = relationship(
        "ExpertiseTemplates", uselist=True, back_populates="users"
    )
    learning_templates: Mapped[List["LearningTemplates"]] = relationship(
        "LearningTemplates", uselist=True, back_populates="users"
    )
    ...
    template_passports: Mapped[List["TemplatePassports"]] = relationship(
        "TemplatePassports", uselist=True, back_populates="users"
    )
    templates: Mapped[List["Templates"]] = relationship("Templates", uselist=True, back_populates="users")
    tracking_templates: Mapped[List["TrackingTemplates"]] = relationship(
        "TrackingTemplates", uselist=True, back_populates="users"
    )
    ...
    learning_leader: Mapped[List["LearningLeader"]] = relationship(
        "LearningLeader", uselist=True, back_populates="users"
    )
    lecturers: Mapped[List["Lecturers"]] = relationship("Lecturers", uselist=True, back_populates="users")
    tracking_storage: Mapped[List["TrackingStorage"]] = relationship(
        "TrackingStorage", uselist=True, back_populates="users"
    )
...
class CertificateTemplates(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["certificate_type_id_certificate_type"],
            ["certificate_type.id_certificate_type"],
            name="fk_certificate_templates_certificate_type1",
        ),
        ForeignKeyConstraint(
            ["forms_id_forms"], ["forms.id_forms"], ondelete="CASCADE", name="fk_certificate_templates_forms1"
        ),
    ...
    certificate_type: Mapped["CertificateType"] = relationship(
        "CertificateType", back_populates="certificate_templates"
    )
...
class ExpertiseTemplates(Base):
    ...
    template_expertises: Mapped[List["TemplateExpertises"]] = relationship(
        "TemplateExpertises", uselist=True, back_populates="expertise_templates"
    )
    template_expertise_criteria: Mapped[List["TemplateExpertiseCriteria"]] = relationship(
        "TemplateExpertiseCriteria", uselist=True, back_populates="expertise_templates"
    )
...
class Expertises(Base):
    ...
    expertise_criteria: Mapped[List["ExpertiseCriteria"]] = relationship(
        "ExpertiseCriteria", uselist=True, back_populates="expertises"
    )
    project_search: Mapped[List["ProjectSearch"]] = relationship(
        "ProjectSearch", uselist=True, back_populates="expertises"
    )
    experts: Mapped[List["Experts"]] = relationship("Experts", uselist=True, back_populates="expertises")
    expertise_information: Mapped[List["ExpertiseInformation"]] = relationship(
        "ExpertiseInformation", uselist=True, back_populates="expertises"
    )
    expertise_project_data: Mapped[List["ExpertiseProjectData"]] = relationship(
        "ExpertiseProjectData", uselist=True, back_populates="expertises"
    )
...
class FeedbackFormFields(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(["forms_id_forms"], ["forms.id_forms"], ondelete="CASCADE", name="fk_form_fields_forms11"),
    ...
    feedback_field_types: Mapped["FeedbackFieldTypes"] = relationship(
        "FeedbackFieldTypes", back_populates="feedback_form_fields"
    )
    forms: Mapped["Forms"] = relationship("Forms", back_populates="feedback_form_fields")
    feedback_sets_values_fields: Mapped[List["FeedbackSetsValuesFields"]] = relationship(
        "FeedbackSetsValuesFields", uselist=True, back_populates="feedback_form_fields"
    )
...
class FormFields(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["field_types_id_field_types"],
            ["field_types.id_field_types"],
            ondelete="CASCADE",
    ...
    passport_fields: Mapped[List["PassportFields"]] = relationship(
        "PassportFields", uselist=True, back_populates="form_fields"
    )
    project_search: Mapped[List["ProjectSearch"]] = relationship(
        "ProjectSearch", uselist=True, back_populates="form_fields"
    )
    sets_values_fields: Mapped[List["SetsValuesFields"]] = relationship(
        "SetsValuesFields", uselist=True, back_populates="form_fields"
    )
...
class IndustryDirections(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["forms_id_forms"], ["forms.id_forms"], ondelete="CASCADE", name="fk_industry_directions_forms1"
        ),
...
class InstitutionInstitutionForms(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["institutes_id_institutes"],
            ["institutes.id_institutes"],
            ondelete="CASCADE",
            name="fk_institution_institution_forms_institutes1",
        ),
        ForeignKeyConstraint(
            ["institution_forms_id_institution_forms"],
            ["institution_forms.id_institution_forms"],
            ondelete="CASCADE",
            name="fk_institution_institution_forms_institution_forms1",
        ),
    ...
    institution_forms: Mapped["InstitutionForms"] = relationship(
        "InstitutionForms", back_populates="institution_institution_forms"
    )
...
class InstitutionRegions(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["regions_id_regions"], ["regions.id_regions"], ondelete="CASCADE", name="fk_institution_region_regions1"
        ),
...
class LearningModules(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["forms_id_forms"], ["forms.id_forms"], ondelete="CASCADE", name="fk_learning_modules_forms1"
        ),
    ...
    learning_topics: Mapped[List["LearningTopics"]] = relationship(
        "LearningTopics", uselist=True, back_populates="learning_modules"
    )
...
class LearningTemplates(Base):
    ...
    template_learning_modules: Mapped[List["TemplateLearningModules"]] = relationship(
        "TemplateLearningModules", uselist=True, back_populates="learning_templates"
    )
...
class ModerCriteria(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["forms_id_forms"], ["forms.id_forms"], ondelete="CASCADE", name="fk_moder_criteria_forms2"
        ),
    ...
    project_moder_evaluation: Mapped[List["ProjectModerEvaluation"]] = relationship(
        "ProjectModerEvaluation", uselist=True, back_populates="moder_criteria"
    )
...
class Passports(Base):
    ...
    passport_fields: Mapped[List["PassportFields"]] = relationship(
        "PassportFields", uselist=True, back_populates="passports"
    )
    passport_information: Mapped[List["PassportInformation"]] = relationship(
        "PassportInformation", uselist=True, back_populates="passports"
    )
...
class PervichCriteria(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["forms_id_forms"], ["forms.id_forms"], ondelete="CASCADE", name="fk_pervich_criteria_forms1"
        ),
    ...
    project_pervich_evaluation: Mapped[List["ProjectPervichEvaluation"]] = relationship(
        "ProjectPervichEvaluation", uselist=True, back_populates="pervich_criteria"
    )
...
class ResumeFiles(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["users_id"], ["users.id"], ondelete="CASCADE", onupdate="SET NULL", name="fk_resume_files_users1"
        ),
...
class Supports(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["support_statuses_id_support_statuses"],
            ["support_statuses.id_support_statuses"],
    ...
    support_regions: Mapped[List["SupportRegions"]] = relationship(
        "SupportRegions", uselist=True, back_populates="supports"
    )
    support_support_directions: Mapped[List["SupportSupportDirections"]] = relationship(
        "SupportSupportDirections", uselist=True, back_populates="supports"
    )
    support_support_forms: Mapped[List["SupportSupportForms"]] = relationship(
        "SupportSupportForms", uselist=True, back_populates="supports"
    )
    support_support_members: Mapped[List["SupportSupportMembers"]] = relationship(
        "SupportSupportMembers", uselist=True, back_populates="supports"
    )
    support_support_reasons: Mapped[List["SupportSupportReasons"]] = relationship(
        "SupportSupportReasons", uselist=True, back_populates="supports"
    )
...
class TemplatePassports(Base):
    ...
    template_passport_fields: Mapped[List["TemplatePassportFields"]] = relationship(
        "TemplatePassportFields", uselist=True, back_populates="template_passports"
    )
...
class Templates(Base):
    ...
    template_fields: Mapped[List["TemplateFields"]] = relationship(
        "TemplateFields", uselist=True, back_populates="templates"
    )
    template_steps: Mapped[List["TemplateSteps"]] = relationship(
        "TemplateSteps", uselist=True, back_populates="templates"
    )
...
class TrackingFormFields(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["tracking_field_types_id_tracking_field_types"],
            ["tracking_field_types.id_tracking_field_types"],
            ondelete="CASCADE",
    ...
    tracking_field_types: Mapped["TrackingFieldTypes"] = relationship(
        "TrackingFieldTypes", back_populates="tracking_form_fields"
    )
    project_search: Mapped[List["ProjectSearch"]] = relationship(
        "ProjectSearch", uselist=True, back_populates="tracking_form_fields"
    )
    sets_values_tracking_fields: Mapped[List["SetsValuesTrackingFields"]] = relationship(
        "SetsValuesTrackingFields", uselist=True, back_populates="tracking_form_fields"
    )
...
class TrackingSteps(Base):
    ...
    tracking_storage_field: Mapped[List["TrackingStorageField"]] = relationship(
        "TrackingStorageField", uselist=True, back_populates="tracking_steps"
    )
    tracking_results: Mapped[List["TrackingResults"]] = relationship(
        "TrackingResults", uselist=True, back_populates="tracking_steps"
    )
    tracking_call: Mapped[List["TrackingCall"]] = relationship(
        "TrackingCall", uselist=True, back_populates="tracking_steps"
    )
...
class TrackingTemplates(Base):
    ...
    tracking_template_fields: Mapped[List["TrackingTemplateFields"]] = relationship(
        "TrackingTemplateFields", uselist=True, back_populates="tracking_templates"
    )
    tracking_template_steps: Mapped[List["TrackingTemplateSteps"]] = relationship(
        "TrackingTemplateSteps", uselist=True, back_populates="tracking_templates"
    )
...
class UserEvents(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["event_roles_id_event_roles"],
            ["event_roles.id_event_roles"],
            ondelete="CASCADE",
            name="fk_user_events_event_roles1",
        ),
        ForeignKeyConstraint(
            ["events_id_forms"], ["forms.id_forms"], ondelete="CASCADE", name="fk_user_events_events1"
        ),
        ForeignKeyConstraint(
            ["users_id"], ["users.id"], ondelete="CASCADE", onupdate="SET NULL", name="fk_user_events_users1"
        ),
...
class UserMarkers(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["markers_id_markers"], ["markers.id_markers"], ondelete="CASCADE", name="fk_user_markers_markers1"
        ),
        ForeignKeyConstraint(
            ["users_id"], ["users.id"], ondelete="SET NULL", onupdate="SET NULL", name="fk_user_markers_users1"
        ),
...
class ExpertiseCriteria(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["expertises_id_expertises"],
            ["expertises.id_expertises"],
            ondelete="CASCADE",
        ...
        Index(
            "fk_expertise_criteria_expertise_criteria_types1_idx",
            "expertise_criteria_types_id_expertise_criteria_types",
        ),
    ...
    expertise_criteria_types: Mapped["ExpertiseCriteriaTypes"] = relationship(
        "ExpertiseCriteriaTypes", back_populates="expertise_criteria"
    )
    ...
    sets_values_criteria: Mapped[List["SetsValuesCriteria"]] = relationship(
        "SetsValuesCriteria", uselist=True, back_populates="expertise_criteria"
    )
...
class FeedbackSetsValuesFields(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["feedback_form_fields.id_feedback_form_fields"],
            ondelete="CASCADE",
            name="fk_feedback_sets_values_fields_feedback_form_fields1",
        ),
        Index(
            "fk_feedback_sets_values_fields_feedback_form_fields1_idx", "feedback_form_fields_id_feedback_form_fields"
        ),
    )
    ...
    feedback_form_fields: Mapped["FeedbackFormFields"] = relationship(
        "FeedbackFormFields", back_populates="feedback_sets_values_fields"
    )
...
class LearningTopics(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["learning_modules_id_learning_modules"],
            ["learning_modules.id_learning_modules"],
            ondelete="CASCADE",
            name="fk_learning_topics_learning_modules1",
        ),
    ...
    learning_leader: Mapped[List["LearningLeader"]] = relationship(
        "LearningLeader", uselist=True, back_populates="learning_topics"
    )
    learning_stat: Mapped[List["LearningStat"]] = relationship(
        "LearningStat", uselist=True, back_populates="learning_topics"
    )
    learning_task: Mapped[List["LearningTask"]] = relationship(
        "LearningTask", uselist=True, back_populates="learning_topics"
    )
...
class PassportFields(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["passport_field_types_id_passport_field_types"],
            ["passport_field_types.id_passport_field_types"],
            ondelete="CASCADE",
            name="fk_passport_fields_passport_field_types1",
        ),
        ForeignKeyConstraint(
            ["passports_id_passports"],
            ["passports.id_passports"],
            ondelete="CASCADE",
    ...
    passport_field_types: Mapped["PassportFieldTypes"] = relationship(
        "PassportFieldTypes", back_populates="passport_fields"
    )
    passports: Mapped["Passports"] = relationship("Passports", back_populates="passport_fields")
    passport_data: Mapped[List["PassportData"]] = relationship(
        "PassportData", uselist=True, back_populates="passport_fields"
    )
    sets_values_passport_fields: Mapped[List["SetsValuesPassportFields"]] = relationship(
        "SetsValuesPassportFields", uselist=True, back_populates="passport_fields"
    )
...
class ProjectSearch(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["expertises_id_expertises"], ["expertises.id_expertises"], name="fk_project_search_expertises1"
        ),
        ForeignKeyConstraint(
            ["form_fields_id_form_fields"], ["form_fields.id_form_fields"], name="fk_project_search_form_fields1"
        ),
        ForeignKeyConstraint(
            ["project_search_type_id_project_search_type"],
    ...
    project_search_type: Mapped["ProjectSearchType"] = relationship(
        "ProjectSearchType", back_populates="project_search"
    )
    tracking_form_fields: Mapped[Optional["TrackingFormFields"]] = relationship(
        "TrackingFormFields", back_populates="project_search"
    )
...
class Projects(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["industry_directions_id_industry_directions"],
            ["industry_directions.id_industry_directions"],
            ondelete="SET NULL",
            name="fk_projects_industry_directions1",
        ),
        ForeignKeyConstraint(
            ["project_statuses_id_project_statuses"],
            ["project_statuses.id_project_statuses"],
    ...
    industry_directions: Mapped[Optional["IndustryDirections"]] = relationship(
        "IndustryDirections", back_populates="projects"
    )
    ...
    feedback_project_data: Mapped[List["FeedbackProjectData"]] = relationship(
        "FeedbackProjectData", uselist=True, back_populates="projects"
    )
    learning_leader: Mapped[List["LearningLeader"]] = relationship(
        "LearningLeader", uselist=True, back_populates="projects"
    )
    ...
    passport_information: Mapped[List["PassportInformation"]] = relationship(
        "PassportInformation", uselist=True, back_populates="projects"
    )
    project_data: Mapped[List["ProjectData"]] = relationship("ProjectData", uselist=True, back_populates="projects")
    project_moder_comments: Mapped[List["ProjectModerComments"]] = relationship(
        "ProjectModerComments", uselist=True, back_populates="projects"
    )
    project_moder_evaluation: Mapped[List["ProjectModerEvaluation"]] = relationship(
        "ProjectModerEvaluation", uselist=True, back_populates="projects"
    )
    tracking_information: Mapped[List["TrackingInformation"]] = relationship(
        "TrackingInformation", uselist=True, back_populates="projects"
    )
    tracking_project_data: Mapped[List["TrackingProjectData"]] = relationship(
        "TrackingProjectData", uselist=True, back_populates="projects"
    )
    tracking_results: Mapped[List["TrackingResults"]] = relationship(
        "TrackingResults", uselist=True, back_populates="projects"
    )
    tracking_storage: Mapped[List["TrackingStorage"]] = relationship(
        "TrackingStorage", uselist=True, back_populates="projects"
    )
    user_project: Mapped[List["UserProject"]] = relationship("UserProject", uselist=True, back_populates="projects")
    expertise_information: Mapped[List["ExpertiseInformation"]] = relationship(
        "ExpertiseInformation", uselist=True, back_populates="projects"
    )
    expertise_project_data: Mapped[List["ExpertiseProjectData"]] = relationship(
        "ExpertiseProjectData", uselist=True, back_populates="projects"
    )
    project_pervich_evaluation: Mapped[List["ProjectPervichEvaluation"]] = relationship(
        "ProjectPervichEvaluation", uselist=True, back_populates="projects"
    )
...
class SetsValuesTrackingFields(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "fk_sets_values_tracking_fields_tracking_form_fields1_idx", "tracking_form_fields_id_tracking_form_fields"
        ),
    )
    ...
    tracking_form_fields: Mapped["TrackingFormFields"] = relationship(
        "TrackingFormFields", back_populates="sets_values_tracking_fields"
    )
...
class SupportRegions(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["regions_id_regions"], ["regions.id_regions"], ondelete="CASCADE", name="fk_support_region_regions1"
        ),
        ForeignKeyConstraint(
            ["supports_id_supports"], ["supports.id_supports"], ondelete="CASCADE", name="fk_support_region_supports1"
        ),
...
class SupportSupportDirections(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["support_directions_id_support_directions"],
            ["support_directions.id_support_directions"],
            ondelete="CASCADE",
            name="fk_support_support_directions_support_directions1",
        ),
        ForeignKeyConstraint(
            ["supports_id_supports"],
    ...
    support_directions: Mapped["SupportDirections"] = relationship(
        "SupportDirections", back_populates="support_support_directions"
    )
...
class SupportSupportForms(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["support_forms_id_support_forms"],
            ["support_forms.id_support_forms"],
            ondelete="CASCADE",
...
class SupportSupportMembers(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["support_members_id_support_members"],
            ["support_members.id_support_members"],
            ondelete="CASCADE",
            name="fk_support_support_members_support_members1",
        ),
        ForeignKeyConstraint(
            ["supports_id_supports"],
            ["supports.id_supports"],
...
class SupportSupportReasons(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["support_reasons_id_support_reasons"],
            ["support_reasons.id_support_reasons"],
            ondelete="CASCADE",
            name="fk_support_support_reasons_support_reasons1",
        ),
        ForeignKeyConstraint(
            ["supports_id_supports"],
            ["supports.id_supports"],
...
class TemplateExpertises(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["expertise_templates_id_expertise_templates"],
    ...
    expertise_templates: Mapped["ExpertiseTemplates"] = relationship(
        "ExpertiseTemplates", back_populates="template_expertises"
    )
    template_expertise_criteria: Mapped[List["TemplateExpertiseCriteria"]] = relationship(
        "TemplateExpertiseCriteria", uselist=True, back_populates="template_expertises"
    )
...
class TemplateFeedbackFormFields(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["learning_templates_id_learning_templates"],
            ["learning_templates.id_learning_templates"],
            ondelete="CASCADE",
            name="fk_template_feedback_form_fields_learning_templates1",
        ),
        Index("fk_feedback_form_fields_feedback_field_types1_idx", "feedback_field_types_id_feedback_field_types"),
    ...
    feedback_field_types: Mapped["FeedbackFieldTypes"] = relationship(
        "FeedbackFieldTypes", back_populates="template_feedback_form_fields"
    )
    learning_templates: Mapped["LearningTemplates"] = relationship(
        "LearningTemplates", back_populates="template_feedback_form_fields"
    )
...
class TemplateFields(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["field_types_id_field_types"], ["field_types.id_field_types"], name="fk_forms_field_types10"
        ),
        ForeignKeyConstraint(
            ["templates_id_templates"], ["templates.id_templates"], name="fk_form_fields_copy1_templates1"
        ),
    ...
    sets_values_template_fields: Mapped[List["SetsValuesTemplateFields"]] = relationship(
        "SetsValuesTemplateFields", uselist=True, back_populates="template_fields"
    )
...
class TemplateLearningModules(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["learning_templates.id_learning_templates"],
            ondelete="CASCADE",
            name="fk_template_learning_modules_learning_templates1",
        ),
    ...
    learning_templates: Mapped["LearningTemplates"] = relationship(
        "LearningTemplates", back_populates="template_learning_modules"
    )
    template_learning_topics: Mapped[List["TemplateLearningTopics"]] = relationship(
        "TemplateLearningTopics", uselist=True, back_populates="template_learning_modules"
    )
...
class TemplatePassportFields(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["template_passports_id_template_passports"],
            ["template_passports.id_template_passports"],
            ondelete="CASCADE",
            name="fk_passport_fields_copy1_template_passports1",
        ),
    ...
    passport_field_types: Mapped["PassportFieldTypes"] = relationship(
        "PassportFieldTypes", back_populates="template_passport_fields"
    )
    template_passports: Mapped["TemplatePassports"] = relationship(
        "TemplatePassports", back_populates="template_passport_fields"
    )
...
class TemplateSteps(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["templates_id_templates"], ["templates.id_templates"], ondelete="CASCADE", name="fk_steps_copy1_templates1"
        ),
...
class TrackingStorageField(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["tracking_steps_id_tracking_steps"],
            ["tracking_steps.id_tracking_steps"],
    ...
    tracking_storage: Mapped[List["TrackingStorage"]] = relationship(
        "TrackingStorage", uselist=True, back_populates="tracking_storage_field"
    )
...
class TrackingTemplateFields(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["tracking_templates_id_tracking_templates"],
            ["tracking_templates.id_tracking_templates"],
            ondelete="CASCADE",
            name="fk_tracking_template_fields_tracking_templates1",
        ),
    ...
    tracking_field_types: Mapped["TrackingFieldTypes"] = relationship(
        "TrackingFieldTypes", back_populates="tracking_template_fields"
    )
    tracking_templates: Mapped["TrackingTemplates"] = relationship(
        "TrackingTemplates", back_populates="tracking_template_fields"
    )
...
class TrackingTemplateSteps(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["tracking_templates.id_tracking_templates"],
            ondelete="CASCADE",
            name="fk_tracking_template_steps_tracking_templates1",
        ),
    ...
    tracking_templates: Mapped["TrackingTemplates"] = relationship(
        "TrackingTemplates", back_populates="tracking_template_steps"
    )
...
class Certificates(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["certificate_type.id_certificate_type"],
            ondelete="CASCADE",
            name="fk_certificates_certificate_type1",
        ),
        ForeignKeyConstraint(["forms_id_forms"], ["forms.id_forms"], ondelete="CASCADE", name="fk_certificates_forms1"),
        ForeignKeyConstraint(
            ["projects_id_projects"], ["projects.id_projects"], ondelete="SET NULL", name="fk_certificates_projects1"
        ),
...
class FeedbackSetsValuesTemplateFields(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["template_feedback_form_fields.id_template_feedback_form_fields"],
            ondelete="CASCADE",
            name="fk_feedback_sets_values_template_fields_template_feedback_for1",
        ),
        Index(
            "fk_feedback_sets_values_template_fields_template_feedback_f_idx",
            "template_feedback_form_fields_id_template_feedback_form_fields",
        ),
    )
    ...
    template_feedback_form_fields: Mapped["TemplateFeedbackFormFields"] = relationship(
        "TemplateFeedbackFormFields", back_populates="feedback_sets_values_template_fields"
    )
...
class LearningLeader(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["learning_topics_id_learning_topics"],
            ["learning_topics.id_learning_topics"],
...
class LearningStat(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["learning_topics.id_learning_topics"],
            ondelete="CASCADE",
            name="fk_learning_stat_learning_topics1",
        ),
        ForeignKeyConstraint(
            ["projects_id_projects"], ["projects.id_projects"], ondelete="CASCADE", name="fk_learning_stat_projects1"
        ),
...
class LearningTask(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["learning_topics.id_learning_topics"],
            ondelete="CASCADE",
            name="fk_learning_task_learning_topics1",
        ),
        ForeignKeyConstraint(
            ["projects_id_projects"], ["projects.id_projects"], ondelete="CASCADE", name="fk_learning_task_projects1"
        ),
...
class Lecturers(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["learning_topics.id_learning_topics"],
            ondelete="CASCADE",
            name="fk_lecturers_learning_topics1",
        ),
...
class PassportData(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["passport_fields_id_passport_fields"],
            ["passport_fields.id_passport_fields"],
...
class PassportInformation(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["passport_statuses_id_passport_statuses"],
            ["passport_statuses.id_passport_statuses"],
            name="fk_passport_information_passport_statuses1",
        ),
        ForeignKeyConstraint(
            ["passports_id_passports"], ["passports.id_passports"], name="fk_passport_information_passports1"
        ),
        ForeignKeyConstraint(
            ["projects_id_projects"], ["projects.id_projects"], name="fk_passport_information_projects1"
        ),
    ...
    passport_statuses: Mapped["PassportStatuses"] = relationship(
        "PassportStatuses", back_populates="passport_information"
    )
...
class ProjectData(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["projects_id_projects"], ["projects.id_projects"], ondelete="CASCADE", name="fk_project_data_projects1"
        ),
...
class ProjectModerEvaluation(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["moder_criteria_id_moder_criteria"],
            ["moder_criteria.id_moder_criteria"],
            ondelete="CASCADE",
            name="fk_project_moder_evaluation_moder_criteria1",
        ),
        ForeignKeyConstraint(
            ["projects_id_projects"],
            ["projects.id_projects"],
...
class SetsValuesCriteria(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["expertise_criteria.id_expertise_criteria"],
            ondelete="CASCADE",
            name="fk_sets_values_template_fields_copy1_expertise_criteria1",
        ),
        Index(
            "fk_sets_values_template_fields_copy1_expertise_criteria1_idx", "expertise_criteria_id_expertise_criteria"
        ),
    )
    ...
    expertise_criteria: Mapped["ExpertiseCriteria"] = relationship(
        "ExpertiseCriteria", back_populates="sets_values_criteria"
    )
...
class SetsValuesPassportFields(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["passport_fields.id_passport_fields"],
            ondelete="CASCADE",
            name="fk_sets_values_passport_fields_passport_fields1",
        ),
    ...
    passport_fields: Mapped["PassportFields"] = relationship(
        "PassportFields", back_populates="sets_values_passport_fields"
    )
...
class SetsValuesTemplateFields(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["template_fields_id_template_fields"],
            ["template_fields.id_template_fields"],
            ondelete="CASCADE",
            name="fk_sets_values_fields_copy1_template_fields1",
        ),
    ...
    template_fields: Mapped["TemplateFields"] = relationship(
        "TemplateFields", back_populates="sets_values_template_fields"
    )
...
class SetsValuesTrackingTemplateFields(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["tracking_template_fields.id_tracking_template_fields"],
            ondelete="CASCADE",
            name="fk_sets_values_template_fields_copy1_tracking_template_fields1",
        ),
        Index(
            "fk_sets_values_template_fields_copy1_tracking_template_fiel_idx",
            "tracking_template_fields_id_tracking_template_fields",
        ),
    )
    ...
    tracking_template_fields: Mapped["TrackingTemplateFields"] = relationship(
        "TrackingTemplateFields", back_populates="sets_values_tracking_template_fields"
    )
...
class TemplateExpertiseCriteria(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["template_expertises_id_template_expertises"],
    ...
    expertise_criteria_types: Mapped["ExpertiseCriteriaTypes"] = relationship(
        "ExpertiseCriteriaTypes", back_populates="template_expertise_criteria"
    )
    expertise_templates: Mapped["ExpertiseTemplates"] = relationship(
        "ExpertiseTemplates", back_populates="template_expertise_criteria"
    )
    template_expertises: Mapped["TemplateExpertises"] = relationship(
        "TemplateExpertises", back_populates="template_expertise_criteria"
    )
...
class TemplateLearningTopics(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["template_learning_modules.id_template_learning_modules"],
            ondelete="CASCADE",
            name="fk_template_learning_topics_template_learning_modules1",
        ),
        Index(
            "fk_template_learning_topics_template_learning_modules1_idx",
            "template_learning_modules_id_template_learning_modules",
        ),
    )
    ...
    template_learning_modules: Mapped["TemplateLearningModules"] = relationship(
        "TemplateLearningModules", back_populates="template_learning_topics"
    )
...
class TemplateSetsValuesPassportFields(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["template_passport_fields.id_template_passport_fields"],
            ondelete="CASCADE",
            name="fk_template_sets_values_passport_fields_template_passport_fie1",
        ),
        Index(
            "fk_template_sets_values_passport_fields_template_passport_f_idx",
            "template_passport_fields_id_template_passport_fields",
        ),
    )
    ...
    template_passport_fields: Mapped["TemplatePassportFields"] = relationship(
        "TemplatePassportFields", back_populates="template_sets_values_passport_fields"
    )
...
class TopicInfo(LearningTopics):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["learning_topics.id_learning_topics"],
            ondelete="CASCADE",
            name="fk_topic_info_learning_topics1",
        ),
...
class TrackingInformation(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["tracking_statuses_id_tracking_statuses"],
            ["tracking_statuses.id_tracking_statuses"],
            ondelete="CASCADE",
            name="fk_tracking_information_tracking_statuses1",
        ),
    ...
    tracking_statuses: Mapped[Optional["TrackingStatuses"]] = relationship(
        "TrackingStatuses", back_populates="tracking_information"
    )
    tracking_call: Mapped[List["TrackingCall"]] = relationship(
        "TrackingCall", uselist=True, back_populates="tracking_information"
    )
...
class TrackingProjectData(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["projects_id_projects"], ["projects.id_projects"], ondelete="CASCADE", name="fk_project_data_projects10"
        ),
        Index("fk_project_data_projects1_idx", "projects_id_projects"),
    )
...
class TrackingResults(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["projects_id_projects"], ["projects.id_projects"], ondelete="CASCADE", name="fk_tracking_results_projects1"
        ),
        ForeignKeyConstraint(
            ["tracking_steps_id_tracking_steps"],
            ["tracking_steps.id_tracking_steps"],
            ondelete="CASCADE",
            name="fk_tracking_results_tracking_steps1",
        ),
...
class TrackingStorage(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["tracking_storage_field_id_tracking_storage_field"],
    ...
    tracking_storage_field: Mapped["TrackingStorageField"] = relationship(
        "TrackingStorageField", back_populates="tracking_storage"
    )
...
class UserProject(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["project_roles_id_project_roles"],
            ["project_roles.id_project_roles"],
            ondelete="CASCADE",
        ...
        ForeignKeyConstraint(
            ...
            ondelete="CASCADE",
            onupdate="SET NULL",
            name="fk_user_project_projects1",
        ),
        ForeignKeyConstraint(
            ["users_id"], ["users.id"], ondelete="SET NULL", onupdate="SET NULL", name="fk_user_project_users1"
        ),
...
class Experts(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["user_project_id_user_project"],
            ["user_project.id_user_project"],
            ondelete="SET NULL",
            onupdate="SET NULL",
            name="fk_experts_user_project1",
        ),
    ...
    expertise_information: Mapped[List["ExpertiseInformation"]] = relationship(
        "ExpertiseInformation", uselist=True, back_populates="experts"
    )
    expertise_project_data: Mapped[List["ExpertiseProjectData"]] = relationship(
        "ExpertiseProjectData", uselist=True, back_populates="experts"
    )
    project_pervich_evaluation: Mapped[List["ProjectPervichEvaluation"]] = relationship(
        "ProjectPervichEvaluation", uselist=True, back_populates="experts"
    )
...
class SetsValuesTemplateCriteria(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "fk_sets_values_templates_criteria_template_expertise_criter_idx",
            "template_expertise_criteria_id_template_expertise_criteria",
        ),
    )
    ...
    template_expertise_criteria: Mapped["TemplateExpertiseCriteria"] = relationship(
        "TemplateExpertiseCriteria", back_populates="sets_values_template_criteria"
    )
...
class TrackingCall(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["tracking_information_id_tracking_information"],
            ["tracking_information.id_tracking_information"],
            ondelete="CASCADE",
        ...
        ForeignKeyConstraint(
            ...
            ["tracking_steps.id_tracking_steps"],
            ondelete="CASCADE",
            name="fk_tracking_call_tracking_steps1",
        ),
    ...
    tracking_information: Mapped["TrackingInformation"] = relationship(
        "TrackingInformation", back_populates="tracking_call"
    )
...
class ExpertiseInformation(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ...
            ondelete="SET NULL",
            onupdate="SET NULL",
            name="fk_expertise_information_projects1",
        ),
...
class ExpertiseProjectData(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ondelete="SET NULL",
            onupdate="SET NULL",
            name="fk_expertise_project_data_expertises1",
        ),
        ForeignKeyConstraint(
            ["experts_id_experts"],
            ["experts.id_experts"],
        ...
        ForeignKeyConstraint(
            ...
            ondelete="SET NULL",
            onupdate="SET NULL",
            name="fk_project_data_projects100",
        ),
...
class ProjectPervichEvaluation(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["experts_id_experts"], ["experts.id_experts"], name="fk_project_pervich_evaluation_experts1"
        ),
        ForeignKeyConstraint(
            ["pervich_criteria_id_pervich_criteria"],
            ["pervich_criteria.id_pervich_criteria"],
            name="fk_project_moder_evaluation_copy1_pervich_criteria1",
        ),
        ForeignKeyConstraint(
            ["projects_id_projects"], ["projects.id_projects"], name="fk_project_moder_evaluation_projects100"
        ),
    ...
    pervich_criteria: Mapped["PervichCriteria"] = relationship(
        "PervichCriteria", back_populates="project_pervich_evaluation"
    )
